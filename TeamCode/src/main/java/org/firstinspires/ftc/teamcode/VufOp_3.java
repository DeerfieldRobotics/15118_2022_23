...
public class VufOp_3 extends LinearOpMode
{
    ...
    @Override public void runOpMode()
    {
        ...
        VuforiaTrackables targetsPowerPlay = this.vuforia.loadTrackablesFromAsset("RoverImage");
        targetsPowerPlay.get(0).setName("RED_E6_TOWERS");
        targetsPowerPlay.get(1).setName("RED_E1_ENGINE");
        targetsPowerPlay.get(2).setName("BLUE_B6_CHIP");
        targetsPowerPlay.get(3).setName("BLUE_B1_WIRES");
